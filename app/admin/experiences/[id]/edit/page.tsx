...
export default function EditExperiencePage() {
      ...
      try {
        ...
        reset({
          ...
          projects: (experience.projects || []).map(project => ({
            ...project,
            architectureDiagrams: Array.isArray(project.architectureDiagrams) 
              ? project.architectureDiagrams.filter((url: string) => url && url.trim()).join('\n')
              : (typeof project.architectureDiagrams === 'string' ? project.architectureDiagrams : ''),
          })),
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Experience</h1>
